...
public class QuestionCandSentSimilarityMatcher extends JCasAnnotator_ImplBase {
  ...
  public String formSolrQuery(Question question) {
    ...
    try {
      BufferedWriter bW = new BufferedWriter(new FileWriter("NamedEntities.txt", true));
      ...
      for (int i = 0; i < nounPhrases.size(); i++) {
        ...
        bW.write(nounPhrases.get(i).getText() + "\n");
        System.out.println("NOUN PHRASE: " + nounPhrases.get(i).getText());
      }
      ...
      for (int i = 0; i < neList.size(); i++) {
        ...
        bW.write(neList.get(i).getText() + "\n");
        System.out.println("NAMED ENTITY: " + neList.get(i).getText());
      }
